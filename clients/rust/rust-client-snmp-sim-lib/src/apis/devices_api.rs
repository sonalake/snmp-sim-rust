...
) -> Result<Vec<crate::models::ResponseDevice>, Error<DevicesGetError>> {
...
pub async fn devices_id_delete(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::ResponseDevice, Error<DevicesIdDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn devices_id_get(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::ResponseDevice, Error<DevicesIdGetError>> {
    let local_var_configuration = configuration;
...
pub async fn devices_id_put(
    configuration: &configuration::Configuration,
    id: &str,
    body: crate::models::RequestDevice,
) -> Result<crate::models::ResponseDevice, Error<DevicesIdPutError>> {
    let local_var_configuration = configuration;
...
pub async fn devices_id_start_put(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<bool, Error<DevicesIdStartPutError>> {
    let local_var_configuration = configuration;
...
pub async fn devices_id_stop_put(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<bool, Error<DevicesIdStopPutError>> {
    let local_var_configuration = configuration;
...
pub async fn devices_post(
    configuration: &configuration::Configuration,
    body: crate::models::RequestDevice,
) -> Result<crate::models::ResponseDevice, Error<DevicesPostError>> {
    let local_var_configuration = configuration;
