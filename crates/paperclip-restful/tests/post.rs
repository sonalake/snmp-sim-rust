...
use paperclip_restful::{JsonError, PostResponse};
...
fn test_post_response() {
    ...
    #[api_v2_operation]
    #[post("/")]
    async fn post_person(_: HttpRequest) -> Result<PostResponse<Person>, JsonError<PersonError>> {
    ...
    assert_eq!(
        r##"{"definitions":{"Person":{"properties":{"first_name":{"type":"string"},"last_name":{"type":"string"}},"required":["first_name","last_name"],"type":"object"}},"info":{"title":"","version":""},"paths":{"/":{"post":{"responses":{"200":{"description":"OK","schema":{"$ref":"#/definitions/Person"}},"201":{"description":"Created","schema":{"$ref":"#/definitions/Person"}},"400":{"description":"Bad request"},"404":{"description":"Not found"}}}}},"swagger":"2.0"}"##,
        json_spec
    );
}
