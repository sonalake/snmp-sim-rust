        ...
        let request = crate::v2c::Message {
            ...
            data: Response(Pdu {
                ...
                variable_bindings: vec![
                    VarBind {
                        name: ObjectIdentifier::new_unchecked(vec![1, 3, 6, 1, 2, 1, 2, 2, 1, 1, 12].into()),
                        value: VarBindValue::NoSuchInstance,
                    },
                    VarBind {
                        name: ObjectIdentifier::new_unchecked(vec![1, 3, 6, 1, 2, 1, 2, 2, 1, 1, 13].into()),
                        value: VarBindValue::Value(ObjectSyntax::Simple(SimpleSyntax::Integer(6.into()))),
                    },
                ],
            }),
        };
