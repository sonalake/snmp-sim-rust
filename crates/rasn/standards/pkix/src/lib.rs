...
mod tests {
    ...
    fn time() {
        rasn::der::decode::<Time>(&[
            0x17, 0x0D, 0x31, 0x38, 0x30, 0x32, 0x30, 0x39, 0x31, 0x32, 0x33, 0x32, 0x30, 0x37, 0x5A,
        ])
        .unwrap();
    }
    ...
    fn certificate_policies() {
        let expected_de: CertificatePolicies = alloc::vec![
            ...
            PolicyInformation {
                policy_identifier: ObjectIdentifier::new_unchecked((&[1, 3, 6, 1, 4, 1, 44947, 1, 1, 1][..]).into()),
        ...
        let expected_enc = &[
            0x30, 0x4B, 0x30, 0x08, 0x06, 0x06, 0x67, 0x81, 0x0C, 0x01, 0x02, 0x01, 0x30, 0x3F, 0x06, 0x0B, 0x2B, 0x06,
            0x01, 0x04, 0x01, 0x82, 0xDF, 0x13, 0x01, 0x01, 0x01, 0x30, 0x30, 0x30, 0x2E, 0x06, 0x08, 0x2B, 0x06, 0x01,
            0x05, 0x05, 0x07, 0x02, 0x01, 0x16, 0x22, 0x68, 0x74, 0x74, 0x70, 0x3A, 0x2F, 0x2F, 0x63, 0x70, 0x73, 0x2E,
            0x72, 0x6F, 0x6F, 0x74, 0x2D, 0x78, 0x31, 0x2E, 0x6C, 0x65, 0x74, 0x73, 0x65, 0x6E, 0x63, 0x72, 0x79, 0x70,
