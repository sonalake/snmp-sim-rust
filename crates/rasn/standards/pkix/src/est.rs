...
pub const ASYMMETRIC_DECRYPT_KEY_OID: ConstOid = Oid::ISO_MEMBER_BODY_US_RSADSI_PKCS9_SMIME_AA_ASYMMETRIC_DECRYPT_KEY;
...
mod tests {
    ...
    fn csr_attributes_encode() {
        let data = vec![
            ...
            AttrOrOid::Oid(rasn::types::ObjectIdentifier::new_unchecked(Cow::from(vec![
                1, 2, 840, 10045, 4, 3, 2,
            ]))),
            ...
            AttrOrOid::Attribute(Attribute {
                r#type: rasn::types::ObjectIdentifier::new_unchecked(Cow::from(vec![1, 3, 6, 1, 5, 5, 7, 48, 1])),
                values: (|| {
                    let mut b = BTreeSet::new();
                    b.insert(rasn::types::Any::new(
                        rasn::der::encode(&rasn::types::PrintableString::new("And me second".to_string())).unwrap(),
                    ));
                    ...
                    b.insert(rasn::types::Any::new(
                        rasn::der::encode(&rasn::types::VisibleString::new("Me first!".to_string())).unwrap(),
                    ));
                    b
                })(),
            }),
        ...
        assert_eq!(
            bin,
            [
                48, 114, 6, 8, 42, 134, 72, 206, 61, 4, 3, 2, 6, 3, 85, 4, 3, 6, 9, 42, 134, 72, 134, 247, 13, 1, 9, 1,
                6, 9, 42, 134, 72, 134, 247, 13, 1, 9, 7, 6, 8, 43, 6, 1, 5, 5, 7, 48, 1, 6, 9, 43, 6, 1, 4, 1, 130,
                55, 21, 20, 6, 9, 42, 134, 72, 134, 247, 13, 1, 1, 5, 48, 43, 6, 8, 43, 6, 1, 5, 5, 7, 48, 1, 49, 31,
                1, 1, 0, 5, 0, 19, 13, 65, 110, 100, 32, 109, 101, 32, 115, 101, 99, 111, 110, 100, 26, 9, 77, 101, 32,
    ...
    fn csr_attributes_decode_1() {
        let data = vec![
            ...
            AttrOrOid::Attribute(Attribute {
                r#type: rasn::types::ObjectIdentifier::new_unchecked(Cow::from(vec![1, 2, 840, 10045, 2, 1])),
                values: (|| {
                    let mut b = BTreeSet::new();
                    b.insert(rasn::types::Any::new(
                        // secp384r1 (SECG (Certicom) named elliptic curve)
                        rasn::der::encode(&rasn::types::ObjectIdentifier::new_unchecked(Cow::from(vec![
                            1, 3, 132, 0, 34,
                        ])))
                        .unwrap(),
                    ));
            ...
            AttrOrOid::Attribute(Attribute {
                ...
                r#type: rasn::types::ObjectIdentifier::new_unchecked(Cow::from(vec![1, 2, 840, 113549, 1, 9, 14])),
                values: (|| {
                    let mut b = BTreeSet::new();
                    b.insert(rasn::types::Any::new(
                        rasn::der::encode(&rasn::types::ObjectIdentifier::new_unchecked(Cow::from(vec![
